/**
 * Domain types — mirror the FastAPI backend (apps/api) Pydantic schemas so the
 * typed API client stays honest. Loads/profit model.
 */
...
export type NotificationType = 'document_expiry' | 'daily_summary' | 'system';
...
export interface Vehicle {
  ...
  documents: Partial<Record<DocType, DocumentInfo>>;
